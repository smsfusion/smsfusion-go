 ...
 * @return *HlrCallback
 */
func (a DefaultApi) GetHLR(key string, num string, cc string) (*HlrCallback, *APIResponse, error) {
 ...
 * @return *HlrResult
 */
func (a DefaultApi) GetHLRCallback(key string, num []string, cb string, cc string) (*HlrResult, *APIResponse, error) {
